<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ItemsAdd.aspx.cs" Inherits="SSS.Webapplication.Purchase.ItemsAdd" EnableEventValidation="false"  MaintainScrollPositionOnPostback="true"  %>
        ...
        <tr>
            ...
            <tr>
                ...
                <td class="auto-style1">
                 ...
                 <tr >
                <td class="auto-style1">
                    <asp:Label ID="Label4" runat="server" Text="  Date: *" Visible="false">
</asp:Label>
                </td>
                <td class="auto-style1">
                    <asp:TextBox ID="TextBox2" runat="server" Enabled="false" Visible="false" Width="160px">
  
    </asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtdilvrydate" CssClass="error" ErrorMessage="*" InitialValue="-1" ValidationGroup="Select"></asp:RequiredFieldValidator>
                </td>
            </tr>
              <tr >
                <td class="auto-style1">
                    <asp:Label ID="Label5" runat="server" Text="  Year: *" Visible="false">
</asp:Label>
                </td>
                <td class="auto-style1">
                    <asp:TextBox ID="TextBox3" runat="server" Enabled="false" Visible="false" Width="160px">
  
    </asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtdilvrydate" CssClass="error" ErrorMessage="*" InitialValue="-1" ValidationGroup="Select"></asp:RequiredFieldValidator>
                </td>
            </tr>
              <tr >
                <td class="auto-style1">
                    <asp:Label ID="Label6" runat="server" Text="  Reference #1: *" Visible="false">
</asp:Label>
                </td>
                <td class="auto-style1">
                    <asp:TextBox ID="TextBox4" runat="server" Enabled="false" Visible="false" Width="160px">
  
    </asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtdilvrydate" CssClass="error" ErrorMessage="*" InitialValue="-1" ValidationGroup="Select"></asp:RequiredFieldValidator>
                </td>
            </tr>
              <tr >
                <td class="auto-style1">
                    <asp:Label ID="Label7" runat="server" Text="  Reference #2: *" Visible="false">
</asp:Label>
                </td>
                <td class="auto-style1">
                    <asp:TextBox ID="TextBox5" runat="server" Enabled="false" Visible="false" Width="160px">
  
    </asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtdilvrydate" CssClass="error" ErrorMessage="*" InitialValue="-1" ValidationGroup="Select"></asp:RequiredFieldValidator>
                </td>
            </tr>
              <tr >
                <td class="auto-style1">
                    <asp:Label ID="Label8" runat="server" Text="  Reference #3: *" Visible="false">
</asp:Label>
                </td>
                <td class="auto-style1">
                    <asp:TextBox ID="TextBox6" runat="server" Enabled="false" Visible="false" Width="160px">
  
    </asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="txtdilvrydate" CssClass="error" ErrorMessage="*" InitialValue="-1" ValidationGroup="Select"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="lbldate" runat="server" Text="  Doc No: *" Visible="false">
</asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtdilvrydate" runat="server" Enabled="false" Visible="false" Width="160px">
  
    </asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtdilvrydate" CssClass="error" ErrorMessage="*" InitialValue="-1" ValidationGroup="Select"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="Label3" runat="server" Text="  Location: *" Visible="false">
</asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="TextBox1" runat="server" Enabled="false" Visible="false" Width="160px">
  
    </asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtdilvrydate" CssClass="error" ErrorMessage="*" InitialValue="-1" ValidationGroup="Select"></asp:RequiredFieldValidator>
                </td>
            </tr>
             <tr >
                <td class="auto-style1">
                    <asp:Label ID="Label9" runat="server" Text="  Naration: *" Visible="false">
</asp:Label>
                </td>
               
                <td class="auto-style1">

                    <asp:TextBox ID="TextBox7" runat="server" Enabled="false" Visible="false" Width="160px">
  
    </asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="txtdilvrydate" CssClass="error" ErrorMessage="*" InitialValue="-1" ValidationGroup="Select"></asp:RequiredFieldValidator>
                </td>
            </tr>
               <td class="auto-style4" >
                <asp:Button style="margin-left:10px; " ID="Button3" runat="server" onclick="btnSubmit_Click" Text="Select Requisition material user recquired" ValidationGroup="Select" />
                <%--  onkeypress="javascript:Callme(event, this.id);"--%>
            </td>
              <td class="auto-style4">
    ...
    <div id="cashMemoDiv">
                <table ID="tblCashMemoDetail" runat="server" align="center" class="new " width="100%" cellpadding="0" cellspacing="0">
                     ...
                     <tr class="detail-div">
                        ...
                        <td >
                            <asp:Label ID="Label11" runat="server" Text="Discription: *"></asp:Label>
                        </td>
                        <td style="display:none" id="tdlblstock" runat="server">
                            <asp:Label ID="lblstock"  runat="server" Text="No of packs:"></asp:Label>
                        </td>
                        <td>
                            <asp:Label ID="Label1" runat="server" Text="Pack:*"></asp:Label>
                        </td>
    ...
    ErrorMessage="&lt;br&gt;Select Sale Type" CssClass="error"></asp:RequiredFieldValidator>
         ...
         <td valign="top" class="auto-style3">
              <asp:TextBox ID="TextBox8" CssClass="dll2" runat="server" AutoPostBack="True" Visible="true" 
                                ...
                                Width="150px" onkeydown="return numbersOnly(event);"  ontextchanged="txtstock_TextChanged"
                                 ></asp:TextBox>
                 ...
                 <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                   ...
                   InitialValue="Select Product" Height="18px"></asp:RequiredFieldValidator></td>
                               
                             
           
                       
                        <td style="display:none" valign="top" id="tdtxtstock" runat="server">
                            <asp:TextBox ID="txtstock" CssClass="dll2" runat="server" AutoPostBack="True" Visible="true" 
                                MaxLength="12" style="border:1px solid #8ec1ff; float:left" 
                                Width="150px" onkeydown="return numbersOnly(event);"  ontextchanged="txtstock_TextChanged"
                                 ></asp:TextBox>
                        ...
                        <%--<td valign="top">
                            <asp:TextBox ID="TextBox1" CssClass="dll2" runat="server" 
                                MaxLength="12" style="border:1px solid #8ec1ff; float:left" 
                                 ValidationGroup="Select" Width="150px" 
                                onkeydown="return numbersOnly(event);"  
                                 ></asp:TextBox> <%--onkeypress="javascript:Callme(event, this.id);" ontextchanged="txt_ProdctQuantity_TextChanged"--%>
