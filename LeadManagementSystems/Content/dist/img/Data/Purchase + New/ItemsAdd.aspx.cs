    ...
    public partial class ItemsAdd : System.Web.UI.Page
    {
        ...
        private void BindCashMemoDetail(int cashMemoMasterId)
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    txtdilvrydate.Text = ds.Tables[0].Rows[0]["DeliveryDate"].ToString();
        ...
        protected void btnMasterUpdate_Click(object sender, EventArgs e)
        {
            ...
            objTransactionMasterProperty.DeliveryDate = Convert.ToDateTime(txtdilvrydate.Text.Trim());
        ...
        public void Get_DeliveryMan_Date()
        {
            try
            {
                ...
                if (objTransactionMasterProperty1.Personnel_ID != -1 && objTransactionMasterProperty1.Prp_ID != -1)
                {
                    ...
                    txtdilvrydate.Visible = true;
                    txtdilvrydate.Text = Convert.ToDateTime(ds.Tables[1].Rows[0]["Date"].ToString()).ToShortDateString();
                }
            }
            catch
            {
        ...
        private void bindProduct()
        {
            ...
            dt = objFinalProductSelectionBLL.ViewProductForCashMemo();
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                cmbProduct.DataValueField = "Product_Index";
                cmbProduct.DataBind();
            }
        }
        ...
        protected void rptCashMemoDetail_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (tdlblstock.Visible == true && rptitemlblstocks != null)
                {
            ...
            else
            {
                ...
                if (tdlblstock.Visible == true && rptlblstocks != null)
                {
