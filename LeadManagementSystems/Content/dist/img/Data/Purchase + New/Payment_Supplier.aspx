<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Payment_Supplier.aspx.cs" Inherits="SSS.Webapplication.Purchase.Payment_Supplier" %>
    ...
    <table  width="100%" cellspacing="4">
        ...
        <tr>
            ...
            <td class="auto-style5">
                ...
                <asp:RequiredFieldValidator ID="rfvCompany" runat="server" ControlToValidate="ddlCompany" CssClass="error" ErrorMessage="&lt;br&gt;Please select Payment type" InitialValue="-1" ValidationGroup="Select"></asp:RequiredFieldValidator>
            </td>
               <tr>
                    <td class="auto-style1">
                        <asp:Label ID="Label10" runat="server" Text=" Doc.No: *" Visible="true">
</asp:Label>
                    </td>
                    <td class="auto-style1">
      ...
      <tr >
                <td class="auto-style1">
                    <asp:Label ID="Label1" runat="server" Text="  Date: *" Visible="true">
</asp:Label>
                </td>
                <td class="auto-style1">
            ...
            <td class="auto-style1">
                ...
                <tr>
                    ...
                    <td class="auto-style1">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="TextBox10" CssClass="error" ErrorMessage="*" InitialValue="-1" ValidationGroup="Select"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style1">
                ...
                <tr>
                    <td class="auto-style1">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator19" runat="server" ControlToValidate="TextBox16" CssClass="error" ErrorMessage="*" InitialValue="-1" ValidationGroup="Select"></asp:RequiredFieldValidator>
                    </td>
                    <td class="auto-style1">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator20" runat="server" ControlToValidate="TextBox17" CssClass="error" ErrorMessage="*" InitialValue="-1" ValidationGroup="Select"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style1">
                        <asp:Label ID="Label6" runat="server" Text="  Amount : *" Visible="true">
</asp:Label>
                    </td>
                    <td class="auto-style1">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator22" runat="server" ControlToValidate="TextBox18" CssClass="error" ErrorMessage="*" InitialValue="-1" ValidationGroup="Select"></asp:RequiredFieldValidator>
                    </td>
                 
                </tr>
                <tr>
                    <td class="auto-style1">
                        <asp:Label ID="Label7" runat="server" Text="  Amount (in Rs.) : *" Visible="true">
</asp:Label>
                    </td>
                    <td class="auto-style1">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator24" runat="server" ControlToValidate="TextBox20" CssClass="error" ErrorMessage="*" InitialValue="-1" ValidationGroup="Select"></asp:RequiredFieldValidator>
                    </td>
               
                </tr>
                <tr>
                    <td class="auto-style1">
                        <asp:Label ID="Label12" runat="server" Text=" Adjusted : *" Visible="true">
</asp:Label>
                    </td>
                    <td class="auto-style1">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator26" runat="server" ControlToValidate="TextBox22" CssClass="error" ErrorMessage="*" InitialValue="-1" ValidationGroup="Select"></asp:RequiredFieldValidator>
                    </td>
                      <td class="auto-style1">
                      <asp:CheckBox ID="CheckBox2" runat="server" Text="Round WHT" />  
                    </td>
                </tr>
                </tr>
                <tr>
                    ...
                    <td class="auto-style1">
                        <asp:DropDownList ID="DropDownList1" runat="server" AppendDataBoundItems="true" onchange="PopulateCompany();" Width="160px">
                            <asp:ListItem Value="-1">Please select</asp:ListItem>
                        </asp:DropDownList>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="ddlCompany" CssClass="error" ErrorMessage="&lt;br&gt;Please select Payment mode" InitialValue="-1" ValidationGroup="Select"></asp:RequiredFieldValidator>
                    </td>
                       <td class="auto-style1">
                      <asp:CheckBox ID="CheckBox1" runat="server" Text="Advance payment" />  
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="auto-style1">
                        <asp:DropDownList ID="DropDownList2" runat="server" AppendDataBoundItems="true" onchange="PopulateCompany();" Width="320px">
                            <asp:ListItem Value="-1">Please select</asp:ListItem>
                        </asp:DropDownList>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ControlToValidate="ddlCompany" CssClass="error" ErrorMessage="&lt;br&gt;Please select Bank" InitialValue="-1" ValidationGroup="Select"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style1">
                        <asp:Label ID="Label13" runat="server" Text=" Cheque #  : *" Visible="true">
</asp:Label>
                    </td>
                    <td class="auto-style1">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="TextBox4" CssClass="error" ErrorMessage="*" InitialValue="-1" ValidationGroup="Select"></asp:RequiredFieldValidator>
                    </td>
                </tr>
             <tr >
                <td class="auto-style1">
                    <asp:Label ID="Label4" runat="server" Text=" Date: *" Visible="true">
</asp:Label>
                </td>
                <td class="auto-style1">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txt_box_dilvrydate" CssClass="error" ErrorMessage="*" InitialValue="-1" ValidationGroup="Select"></asp:RequiredFieldValidator>
                </td>
            </tr>
                <tr>
                    <td class="auto-style1">Currency: * </td>
                    <td class="auto-style1">
                        <asp:DropDownList ID="DropDownList3" runat="server" AppendDataBoundItems="true" onchange="PopulateCompany();" Width="160px">
                            <asp:ListItem Value="-1">Please select</asp:ListItem>
                        </asp:DropDownList>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="ddlCompany" CssClass="error" ErrorMessage="&lt;br&gt;Please select Currency" InitialValue="-1" ValidationGroup="Select"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style1">
                        <asp:Label ID="Label9" runat="server" Text="  Exch.Rate: *" Visible="true">
</asp:Label>
                    </td>
                    <td class="auto-style1">
                ...
                <tr>
                    <td class="auto-style1">
                        <asp:Label ID="Label3" runat="server" Text="  Naration: *" Visible="true">
</asp:Label>
                    </td>
                    <td class="auto-style1">
                        <asp:TextBox ID="TextBox5" runat="server" Enabled="true" Height="30px" Visible="true" Width="320px">
  
    </asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ControlToValidate="txtbox_narration" CssClass="error" ErrorMessage="*" InitialValue="-1" ValidationGroup="Select"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                   ...
                   <tr>
                        <td colspan="5" valign="top" >
                            ...
                            <asp:Button style="margin-left:5px;" ID="btndone" runat="server" Text="Delete"  />
                               <asp:Button style="margin-left:5px;" ID="Button1" runat="server" Text="Voucher"  />
                        </td>
                    </tr>
          </table> 
         </div>
