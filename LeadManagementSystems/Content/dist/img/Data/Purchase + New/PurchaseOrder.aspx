<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="PurchaseOrder.aspx.cs" Inherits="SSS.Webapplication.Purchase.PurchaseOrder" %>
    ...
    <table  width="100%" cellspacing="4">
        ...
        <tr>
            <td class="auto-style4">
                <asp:Button style="margin-left:10px;" ID="Button1" runat="server"  Text="General" ValidationGroup="Select" />
                <%--  onkeypress="javascript:Callme(event, this.id);"--%>
            </td>
              <td class="auto-style4">
                <asp:Button style="margin-left:-100px;" ID="BtnNarationcharges" runat="server" Text="Narations Charges" ValidationGroup="Select" />
                <%--  onkeypress="javascript:Callme(event, this.id);"--%>
            </td>
            <td class="auto-style4" >
                <asp:Button style="margin-right:60px;" ID="Button2" runat="server" Text="Populate items on Minimum. stock level" ValidationGroup="Select" />
                <%--  onkeypress="javascript:Callme(event, this.id);"--%>
            </td>
            ...
            <tr>
              ...
              <tr >
                <td class="auto-style1">
                    <asp:Label ID="Label10" runat="server" Text="  P.O.NO: *" Visible="true">
</asp:Label>
                </td>
                <td class="auto-style1">
               ...
               <tr >
                ...
                <td class="auto-style1">
                   ...
                   <tr >
                <td class="auto-style1">
                    <asp:Label ID="Label14" runat="server" Text="  Suppplier D/C refrence : *" Visible="true">
</asp:Label>
                </td>
                <td class="auto-style1">
              ...
              <tr >
                <td class="auto-style1">
                    <asp:Label ID="Label15" runat="server" Text=" L/C Number : *" Visible="true">
</asp:Label>
                </td>
                <td class="auto-style1">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" ControlToValidate="TextBox9" CssClass="error" ErrorMessage="*" InitialValue="-1" ValidationGroup="Select"></asp:RequiredFieldValidator>
                </td>
                      <td class="auto-style1">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" ControlToValidate="TextBox10" CssClass="error" ErrorMessage="*" InitialValue="-1" ValidationGroup="Select"></asp:RequiredFieldValidator>
                </td>
            </tr>
                          <tr >
                <td class="auto-style1">
                    <asp:Label ID="Label16" runat="server" Text=" Others : *" Visible="true">
</asp:Label>
                </td>
                <td class="auto-style1">
          ...
          <%--   <tr >
                 ...
                 <tr>
              <td>
            <asp:RadioButton ID="RadioButton1" runat="server" Text="Purchase Requisition" GroupName="gender" />  
               ...
               <tr>
              <td>
            <asp:RadioButton ID="RadioButton3" runat="server" Text="Stock requisition sheet user defined" GroupName="gender" />  
             ...
             <tr>
              <td>
            <asp:RadioButton ID="RadioButton2" runat="server" Text="Requset for Quotation" GroupName="gender" />  
            ...
            <tr>
            <td class="auto-style4">
                <asp:Button  ID="Button5" runat="server" Text="Select parent Document" ValidationGroup="Select" />
                <%--  onkeypress="javascript:Callme(event, this.id);"--%>
            </td>
                </tr> 
               <tr >
                <td class="auto-style1">
                    <asp:Label ID="Label8" runat="server" Text="  Suppplier : *" Visible="true">
</asp:Label>
                </td>
                <td class="auto-style1">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="TextBox2" CssClass="error" ErrorMessage="*" InitialValue="-1" ValidationGroup="Select"></asp:RequiredFieldValidator>
                </td>
                      <td class="auto-style1">
                    <asp:TextBox ID="TextBox3" runat="server" Enabled="true" Visible="true" Width="160px">
  
    </asp:TextBox>
                    <asp:CalendarExtender ID="CalendarExtender4" runat="server" Enabled="True" TargetControlID="TextBox3">
                </asp:CalendarExtender>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="TextBox3" CssClass="error" ErrorMessage="*" InitialValue="-1" ValidationGroup="Select"></asp:RequiredFieldValidator>
                </td>
            </tr>
               <tr>
                ...
                <td class="auto-style1">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="ddlCompany" CssClass="error" ErrorMessage="&lt;br&gt;Please select Company" InitialValue="-1" ValidationGroup="Select"></asp:RequiredFieldValidator>
                </td>
            </tr>
             <tr>
                <td class="auto-style1">Payment Terms: * </td>
                <td class="auto-style1">
                    <asp:DropDownList ID="DropDownList2" runat="server" AppendDataBoundItems="true" onchange="PopulateCompany();" Width="160px">
                        <asp:ListItem Value="-1">Please select</asp:ListItem>
                    </asp:DropDownList>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ControlToValidate="ddlCompany" CssClass="error" ErrorMessage="&lt;br&gt;Please select Company" InitialValue="-1" ValidationGroup="Select"></asp:RequiredFieldValidator>
                </td>
            </tr>
               <tr >
                <td class="auto-style1">
                    <asp:Label ID="Label13" runat="server" Text=" Delivery at  : *" Visible="true">
</asp:Label>
                </td>
                <td class="auto-style1">
             ...
             <tr >
                <td class="auto-style1">
                    <asp:Label ID="Label3" runat="server" Text="  Instructions: *" Visible="true">
</asp:Label>
                </td>
            ...
            <tr>
                ...
                <td class="auto-style4">
                    <asp:Button ID="Button4" runat="server" Text="Terms and conditions" ValidationGroup="Select" />
                    <%--  onkeypress="javascript:Callme(event, this.id);"--%></td>
                <tr>
                    <td></td>
                    <td>&nbsp;</td>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" style="padding:0px 0 0 0;" width="700">
                                        <tr class="HeaderStyle">
                                          ...
                                          <th style="width:24%">Department</th>
                                            <th style="width:27%">Packs rate</th>
                               ...
                               <ItemTemplate>
                                    <tr class="RowStyle">
                                      ...
                                      <%--  <td style="width:20%"><asp:TextBox ID="txtStockReturnQuantity" runat="server" Text='<%# Eval("productQty")%>' CssClass="txtForm"
                                          ...
                                          <td style="width:25%"><%# Eval("Discription")%></td>
                                        <td style="width:25%"><%# Eval("Product_quantity")%></td>                                     
