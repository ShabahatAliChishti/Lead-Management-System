 <%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master"  CodeBehind="PuchaseRequisition.aspx.cs" Inherits="SSS.Webapplication.Purchase.ItemsAdd" EnableEventValidation="false"  MaintainScrollPositionOnPostback="true"  %>
    ...
    <table  width="100%" cellspacing="4">
        ...
        <tr>
            <td class="auto-style4">
                <asp:Button ID="Button1" runat="server" Text="General" ValidationGroup="Select" />
          ...
          <tr>
               ...
               <%-- <asp:DropDownList ID="DropDownListLocation" runat="server" AppendDataBoundItems="true" onchange="PopulateCompany();" Width="160px">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtbox_narration" CssClass="error" ErrorMessage="*" InitialValue="-1" ValidationGroup="Select"></asp:RequiredFieldValidator>
                     </td>
            </tr>
             <tr >
                <td class="auto-style1">
...
<td style="display:block; margin-top: 12px; "  id="tdtxtstock" runat="server">
         ...
         <td valign="top" class="auto-style3">
              <asp:TextBox ID="textbox_description" CssClass="dll2" runat="server" AutoPostBack="True" Visible="true" 
                    ...
                    <td valign="top">
                            <asp:TextBox ID="txt_ProdctQuantity" CssClass="dll2" runat="server" 
                                ...
                                onkeydown="return numbersOnly(event);" OnTextChanged="txt_ProdctQuantity_TextChanged1"  
                        ...
                        <td valign="top">
                            <asp:TextBox ID="TextBoxrate" CssClass="dll2" runat="server" 
                                MaxLength="12" style="border:1px solid #8ec1ff; float:left" 
                                 ValidationGroup="Select" Width="150px" 
                                onkeydown="return numbersOnly(event);" OnTextChanged="TextBoxrate_TextChanged"  
                                 ></asp:TextBox> 
